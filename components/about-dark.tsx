    ...
    <section className="bg-[#203040] text-white py-20 md:py-28">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-center text-white/60 text-sm md:text-base font-medium leading-relaxed mt-16 max-w-4xl mx-auto">
          Termoizolare Moldova · Hidroizolare Chișinău · Fonoizolare · Spumă Poliuretanică Celulă Deschisă · Spumă Poliuretanică Celulă Închisă · Izolare Fațade · Izolare Acoperiș · Izolare Fundație · Hidroizolare Poliuree · Garanție 25 Ani
        </p>
      </div>
    </section>
  )
