...
export function WhatsAppButton() {
  ...
  // Tooltip apare la 4 secunde, dispare după 6 secunde
  useEffect(() => {
  ...
  return (
    <div className="fixed bottom-6 right-5 z-50 flex flex-col items-end gap-2">
      ...
      <a
        ...
        className="relative w-14 h-14 rounded-full shadow-lg flex items-center justify-center transition-transform duration-200 hover:scale-110 active:scale-95"
