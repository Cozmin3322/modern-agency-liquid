...
const DEFAULT_REVIEWS: Review[] = [
  ...
  { id: '2', name: 'Maria Șerban', rating: 5, text: 'Am contractat hidroizolarea subsolului și sunt foarte mulțumită cu rezultatul. Nu mai am infiltrații și subsolul este sec. Garanția de 25 de ani îmi dă pe deplin siguranța.', date: 'Ianuarie 2024', location: 'Chișinău' },
