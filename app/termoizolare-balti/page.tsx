...
export const metadata: Metadata = {
  ...
  description: "Termoizolare profesională în Bălți cu spumă poliuretanică. Case, hale, blocuri de apartamente. Deplasare gratuită, garanție 25 ani.",
        ...
        <section className="relative min-h-[65vh] flex items-end pt-20 bg-[#1A1D21]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 w-full">
            ...
            <p className="text-xl text-white/75 mb-10 max-w-2xl leading-relaxed">
              Servicii profesionale de termoizolare cu spumă poliuretanică în Bălți și municipiul Bălți. <span className="text-accent font-semibold">387+ proiecte</span> finalizate. Garanție 25 ani. Deplasare gratuită.
            </p>
        ...
        <section className="py-20 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-4 mb-12">
              ...
              <h2 className="text-4xl font-serif uppercase">Servicii în Bălți</h2>
            </div>
        ...
        <section className="py-20 bg-card">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-4 mb-12">
              ...
              <span className="h-px w-12 bg-border" />
              <h2 className="text-4xl font-serif uppercase">Zone Deservite în Bălți</h2>
            </div>
        ...
        <section className="py-20 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-4 mb-12">
              ...
              <span className="h-px w-12 bg-border" />
              <h2 className="text-4xl font-serif uppercase">De Ce IsoThermLux în Bălți?</h2>
            </div>
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ["Cunoaștem condițiile locale", "Climatul din municipiul Bălți — temperaturi extreme iarna, umiditate sezoniera. Știm exact ce tip de spumă funcționează cel mai bine."],
