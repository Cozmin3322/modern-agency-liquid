...
export const metadata: Metadata = {
  ...
  description: "Termoizolare profesională în Ungheni cu spumă poliuretanică. Case private, subsoluri, mansarde. Deplasare gratuită, garanție 25 ani.",
        ...
        <section className="relative min-h-[65vh] flex items-end pt-20 bg-[#1A1D21]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 w-full">
            ...
            <p className="text-xl text-white/75 mb-10 max-w-2xl leading-relaxed">
              Servicii profesionale de termoizolare cu spumă poliuretanică în Ungheni și raionul Ungheni. <span className="text-accent font-semibold">98+ proiecte</span> finalizate. Garanție 25 ani. Deplasare gratuită.
            </p>
