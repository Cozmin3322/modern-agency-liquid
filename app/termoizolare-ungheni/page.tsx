...
const breadcrumb = breadcrumbSchema([
  ...
  { name: 'Termoizolare Ungheni', url: 'https://www.isothermlux.md/termoizolare-ungheni' }
])

export const metadata: Metadata = {
  title: "Termoizolare Ungheni cu Spumă Poliuretanică | IsoThermLux",
  description: "Termoizolare profesională în Ungheni cu spumă poliuretanică. Case private, subsoluri, mansarde. Deplasare gratuită, garanție 25 de ani.",
  keywords: "termoizolare ungheni, izolare ungheni, spumă poliuretanică ungheni, termoizolare raionul Ungheni, izolare termică ungheni Moldova",
  alternates: { canonical: "https://www.isothermlux.md/termoizolare-ungheni" },
}

const AREAS = ["Ungheni oraș", "Costești", "Mănoilești", "Cornești", "Gherman", "Negurenii Vechi"]

export default function Page() {
  return (
    <>
      <Script id="breadcrumb-termoizolare-ungheni" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumb) }} />
      <Header />
      <main className="bg-background">
        ...
        <section className="relative min-h-[65vh] flex items-end pt-20 bg-[#1A1D21]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 w-full">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="font-mono text-sm text-accent uppercase tracking-widest">raionul Ungheni</span>
            </div>
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-serif text-white mb-6 max-w-3xl">
              Termoizolare Ungheni
            </h1>
            <p className="text-xl text-white/75 mb-10 max-w-2xl leading-relaxed">
              Servicii profesionale de termoizolare cu spumă poliuretanică în Ungheni și raionul Ungheni. <span className="text-accent font-semibold">98+ proiecte</span> finalizate. Garanție 25 de ani. Deplasare gratuită.
            </p>
        ...
        <div className="bg-accent">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex flex-wrap gap-8 justify-center md:justify-start">
              {[
                ["98+", "Proiecte în raionul Ungheni"],
        ...
        <section className="py-20 bg-card">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-muted-foreground text-sm mt-6 font-mono">
              * Intervenție și în localitățile din raionul Ungheni. Deplasare gratuită pentru evaluare.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ["Cunoaștem condițiile locale", "Climatul din raionul Ungheni — temperaturi extreme iarna, umiditate sezonieră. Știm exact ce tip de spumă funcționează cel mai bine."],
                ["98+ proiecte realizate", "Experiență vastă în Ungheni și raionul Ungheni. Clienții noștri pot fi contactați pentru referințe."],
                ["Deplasare gratuită la Ungheni", "Evaluare pe loc fără costuri. Ofertă personalizată în 24h."],
        ...
        <section className="py-20 bg-[#1A1D21] text-center">
          <div className="max-w-3xl mx-auto px-4">
            <span className="font-mono text-xs text-accent uppercase tracking-widest block mb-4">Ungheni · raionul Ungheni</span>
            <h2 className="text-4xl font-serif text-white mb-4">Cere Ofertă Gratuită în Ungheni</h2>
