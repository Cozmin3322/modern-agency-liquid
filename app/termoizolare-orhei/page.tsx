...
const breadcrumb = breadcrumbSchema([
  ...
  { name: 'Termoizolare Orhei', url: 'https://www.isothermlux.md/termoizolare-orhei' }
])

export const metadata: Metadata = {
  title: "Termoizolare Orhei cu Spumă Poliuretanică | IsoThermLux",
  description: "Termoizolare profesională în Orhei și raionul Orhei cu spumă poliuretanică. Case private, hale agricole, depozite. Deplasare gratuită.",
  keywords: "termoizolare orhei, izolare orhei, spumă poliuretanică orhei, termoizolare raionul Orhei, izolare termică orhei Moldova",
  alternates: { canonical: "https://www.isothermlux.md/termoizolare-orhei" },
}

const AREAS = ["Orhei oraș", "Ivancea", "Pelivan", "Chiperceni", "Trebujeni", "Seliște"]

export default function Page() {
  return (
    <>
      <Script id="breadcrumb-termoizolare-orhei" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumb) }} />
      <Header />
      <main className="bg-background">
        ...
        <section className="relative min-h-[65vh] flex items-end pt-20 bg-[#1A1D21]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 w-full">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="font-mono text-sm text-accent uppercase tracking-widest">raionul Orhei</span>
            </div>
            ...
            <p className="text-xl text-white/75 mb-10 max-w-2xl leading-relaxed">
              Servicii profesionale de termoizolare cu spumă poliuretanică în Orhei și raionul Orhei. <span className="text-accent font-semibold">214+ proiecte</span> finalizate. Garanție 25 de ani. Deplasare gratuită.
            </p>
        ...
        <section className="py-20 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-serif uppercase mb-12">Servicii în Orhei</h2>
        ...
        <section className="py-20 bg-card">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-serif uppercase mb-12">Zone Deservite în Orhei</h2>
            ...
            <p className="text-muted-foreground text-sm mt-6 font-mono">
              * Intervenție și în localitățile din raionul Orhei. Deplasare gratuită pentru evaluare.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-serif uppercase mb-12">De Ce IsoThermLux în Orhei?</h2>
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ["Cunoaștem condițiile locale", "Climatul din raionul Orhei — temperaturi extreme iarna, umiditate sezonieră. Știm exact ce tip de spumă funcționează cel mai bine."],
                ["214+ proiecte realizate", "Experiență vastă în Orhei și raionul Orhei. Clienții noștri pot fi contactați pentru referințe."],
                ["Deplasare gratuită la Orhei", "Evaluare pe loc fără costuri. Ofertă personalizată în 24h."],
        ...
        <section className="py-20 bg-[#1A1D21] text-center">
          <div className="max-w-3xl mx-auto px-4">
            <span className="font-mono text-xs text-accent uppercase tracking-widest block mb-4">Orhei · raionul Orhei</span>
            <h2 className="text-4xl font-serif text-white mb-4">Cere Ofertă Gratuită în Orhei</h2>
