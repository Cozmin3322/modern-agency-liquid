...
export const metadata: Metadata = {
  ...
  description: "Termoizolare containere metalice cu spumă poliuretanică. Elimini condensul, frigul și zgomotul. Soluție rapidă și durabilă. Garanție 25 de ani. Moldova.",
      ...
      <main className="bg-background">
        ...
        <section className="relative min-h-[60vh] flex items-center pt-20 bg-[#1A1D21]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
            <div className="max-w-3xl">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif font-medium text-white mb-6">Termoizolare Containere Metalice cu Spumă Poliuretanică</h1>
        ...
        <section className="py-20 bg-card">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              <div key={"0"} className="p-6 border border-border rounded-none"><Check className="w-5 h-5 text-accent mb-3" /><h3 className="font-semibold mb-2">Eliminare completă a condensului</h3><p className="text-sm text-foreground/70">Celula închisă acoperă complet metalul. Zero condens, zero rugină.</p></div>
              <div key={"1"} className="p-6 border border-border rounded-none"><Check className="w-5 h-5 text-accent mb-3" /><h3 className="font-semibold mb-2">Izolație termică maximă</h3><p className="text-sm text-foreground/70">De la container neizolat la spațiu confortabil în câteva ore.</p></div>
              <div key={"2"} className="p-6 border border-border rounded-none"><Check className="w-5 h-5 text-accent mb-3" /><h3 className="font-semibold mb-2">Reducerea zgomotului ploii</h3><p className="text-sm text-foreground/70">Spuma amortizează complet zgomotul ploii pe tablă.</p></div>
              <div key={"3"} className="p-6 border border-border rounded-none"><Check className="w-5 h-5 text-accent mb-3" /><h3 className="font-semibold mb-2">Aderare perfectă pe metal</h3><p className="text-sm text-foreground/70">Spuma se lipește chimic de oțel. Nu se desprinde, nu alunecă.</p></div>
              <div key={"4"} className="p-6 border border-border rounded-none"><Check className="w-5 h-5 text-accent mb-3" /><h3 className="font-semibold mb-2">Aplicare rapidă</h3><p className="text-sm text-foreground/70">Un container standard se izolează în câteva ore.</p></div>
              <div key={"5"} className="p-6 border border-border rounded-none"><Check className="w-5 h-5 text-accent mb-3" /><h3 className="font-semibold mb-2">Garanție 25 de ani</h3><p className="text-sm text-foreground/70">Investiție pe termen lung pentru orice utilizare.</p></div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              <div key={"0"} className="p-6 border border-border rounded-none"><h3 className="font-semibold mb-2">Container Birou</h3><p className="text-sm text-foreground/70">Spațiu de lucru confortabil tot anul. Izolat termic și fonic.</p></div>
              <div key={"1"} className="p-6 border border-border rounded-none"><h3 className="font-semibold mb-2">Container Locuință</h3><p className="text-sm text-foreground/70">Transformi containerul în casă mini. Confort complet.</p></div>
              <div key={"2"} className="p-6 border border-border rounded-none"><h3 className="font-semibold mb-2">Container Depozit</h3><p className="text-sm text-foreground/70">Păstrezi mărfurile la temperaturi controlate.</p></div>
              <div key={"3"} className="p-6 border border-border rounded-none"><h3 className="font-semibold mb-2">Container Frigorific</h3><p className="text-sm text-foreground/70">Izolație de înaltă densitate pentru temperaturi negative.</p></div>
              <div key={"4"} className="p-6 border border-border rounded-none"><h3 className="font-semibold mb-2">Container Atelier</h3><p className="text-sm text-foreground/70">Spațiu de lucru cald iarna, răcoros vara.</p></div>
              <div key={"5"} className="p-6 border border-border rounded-none"><h3 className="font-semibold mb-2">Container Server Room</h3><p className="text-sm text-foreground/70">Controlul temperaturii pentru echipamente IT sensibile.</p></div>
            </div>
          </div>
        </section>
