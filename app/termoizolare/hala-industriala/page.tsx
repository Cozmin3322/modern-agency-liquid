...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.isothermlux.md/termoizolare/hala-industriala" },
}
      ...
      <main className="bg-background">
        <section className="relative min-h-screen flex items-center pt-20">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-20 relative">
            <div className="max-w-3xl">
              <p className="text-accent text-sm tracking-widest uppercase mb-4">Termoizolare Industrial</p>
              <h1 className="text-6xl font-serif font-medium text-white mb-6">
                Termoizolare Hale Industriale
              </h1>
        ...
        <section className="py-24 bg-card">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-serif font-medium mb-12">Soluții pentru Hale</h2>
            <div className="grid md:grid-cols-2 gap-8">
              {[
                { title: "Hale Industriale", desc: "Izolație termică pentru hale de producție. Mediu controlat și eficient." },
                { title: "Depozite", desc: "Protecție produse sensibile. Temperatură constantă." },
                { title: "Birouri Comerciale", desc: "Confort termic pentru zone administrative. Economie de energie." },
                { title: "Sisteme Personalizate", desc: "Soluții adaptate la necesitățile specifice. Eficiență maximă." }
              ].map((item, idx) => (
