      ...
      <main className="bg-background">
        ...
        <section className="relative min-h-[60vh] flex items-center pt-20 bg-[#2C3E50]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
            <div className="max-w-3xl">
              ...
              <h1 className="text-5xl lg:text-6xl font-serif font-medium text-white mb-6">Termoizolare Pod cu Spumă Poliuretanică</h1>
        ...
        <section className="py-20 bg-card">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div key={"0"} className="p-6 border border-border rounded-lg"><Check className="w-5 h-5 text-accent mb-3" /><h3 className="font-semibold mb-2">Camera de dedesubt mai caldă iarna</h3><p className="text-sm text-foreground/70">Izolând podeaua sau tavanul podului, camera de sub el e cu 4-6°C mai caldă.</p></div>
              <div key={"1"} className="p-6 border border-border rounded-lg"><Check className="w-5 h-5 text-accent mb-3" /><h3 className="font-semibold mb-2">Mai răcoros vara</h3><p className="text-sm text-foreground/70">Spuma reflectă și absoarbe căldura soarelui. Nu mai transpiți la ultimul etaj.</p></div>
              <div key={"2"} className="p-6 border border-border rounded-lg"><Check className="w-5 h-5 text-accent mb-3" /><h3 className="font-semibold mb-2">Aplicare rapidă și curată</h3><p className="text-sm text-foreground/70">Podul se izolează în câteva ore. Fără praf, fără demolări.</p></div>
              <div key={"3"} className="p-6 border border-border rounded-lg"><Check className="w-5 h-5 text-accent mb-3" /><h3 className="font-semibold mb-2">Acoperire pe structuri neregulate</h3><p className="text-sm text-foreground/70">Căpriori, grinzi, colțuri — spuma acoperă perfect orice geometrie.</p></div>
              <div key={"4"} className="p-6 border border-border rounded-lg"><Check className="w-5 h-5 text-accent mb-3" /><h3 className="font-semibold mb-2">Izolație fonică inclusă</h3><p className="text-sm text-foreground/70">Ploaia pe acoperiș nu se mai aude. Liniște completă.</p></div>
              <div key={"5"} className="p-6 border border-border rounded-lg"><Check className="w-5 h-5 text-accent mb-3" /><h3 className="font-semibold mb-2">Garanție 25 ani</h3><p className="text-sm text-foreground/70">Nu mai reizolezi niciodată. Soluție definitivă.</p></div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div key={"0"} className="p-6 border border-border rounded-lg"><h3 className="font-semibold mb-2">Pod Neamenajat</h3><p className="text-sm text-foreground/70">Izolăm podeaua podului. Camera de dedesubt devine imediat mai caldă.</p></div>
              <div key={"1"} className="p-6 border border-border rounded-lg"><h3 className="font-semibold mb-2">Pod în Curs de Amenajare</h3><p className="text-sm text-foreground/70">Izolăm acoperișul podului pentru a-l transforma în cameră locuibilă.</p></div>
              <div key={"2"} className="p-6 border border-border rounded-lg"><h3 className="font-semibold mb-2">Pod cu Acces Limitat</h3><p className="text-sm text-foreground/70">Spuma se aplică și în spații greu accesibile. Acoperire completă.</p></div>
              <div key={"3"} className="p-6 border border-border rounded-lg"><h3 className="font-semibold mb-2">Pod Industrial</h3><p className="text-sm text-foreground/70">Depozite și hale cu pod înalt. Economii uriașe la climatizare.</p></div>
              <div key={"4"} className="p-6 border border-border rounded-lg"><h3 className="font-semibold mb-2">Pod cu Instalații</h3><p className="text-sm text-foreground/70">Spuma înconjoară țevile și cablurile. Protecție termică și mecanică.</p></div>
              <div key={"5"} className="p-6 border border-border rounded-lg"><h3 className="font-semibold mb-2">Pod Mansardat</h3><p className="text-sm text-foreground/70">Transformarea podului în spațiu locuibil confortabil.</p></div>
            </div>
          </div>
        </section>
