...
export const metadata: Metadata = {
  ...
  description: "Termoizolare planșee, tavane și podele cu spumă poliuretanică. Elimini pierderile de căldură prin planșeu. Garanție 25 de ani. Moldova.",
      ...
      <main className="bg-background">
        ...
        <section className="relative min-h-[60vh] flex items-center pt-20 bg-[#1A1D21]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
            <div className="max-w-3xl">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif font-medium text-white mb-6">Termoizolare Planșee și Tavane cu Spumă Poliuretanică</h1>
        ...
        <section className="py-20 bg-card">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              <div key={"0"} className="p-6 border border-border rounded-none"><Check className="w-5 h-5 text-accent mb-3" /><h3 className="font-semibold mb-2">Aplicare rapidă pe loc</h3><p className="text-sm text-foreground/70">Spuma se aplică direct pe tavanul existent. Fără demolări, fără praf excesiv.</p></div>
              <div key={"1"} className="p-6 border border-border rounded-none"><Check className="w-5 h-5 text-accent mb-3" /><h3 className="font-semibold mb-2">Acoperire 100% a suprafeței</h3><p className="text-sm text-foreground/70">Niciun rost, nicio zonă neizolată. Strat complet și uniform.</p></div>
              <div key={"2"} className="p-6 border border-border rounded-none"><Check className="w-5 h-5 text-accent mb-3" /><h3 className="font-semibold mb-2">Reducere zgomot între etaje</h3><p className="text-sm text-foreground/70">Spuma cu celulă deschisă izolează fonic excelent. Confort sporit.</p></div>
              <div key={"3"} className="p-6 border border-border rounded-none"><Check className="w-5 h-5 text-accent mb-3" /><h3 className="font-semibold mb-2">Greutate redusă</h3><p className="text-sm text-foreground/70">Spuma e ușoară. Nu solicită structura planșeului.</p></div>
              <div key={"4"} className="p-6 border border-border rounded-none"><Check className="w-5 h-5 text-accent mb-3" /><h3 className="font-semibold mb-2">Compatibil cu instalații</h3><p className="text-sm text-foreground/70">Spuma înconjoară țevile și cablurile. Nu blochează accesul la instalații.</p></div>
              <div key={"5"} className="p-6 border border-border rounded-none"><Check className="w-5 h-5 text-accent mb-3" /><h3 className="font-semibold mb-2">Garanție 25 de ani</h3><p className="text-sm text-foreground/70">Soluție permanentă fără întreținere.</p></div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              <div key={"0"} className="p-6 border border-border rounded-none"><h3 className="font-semibold mb-2">Tavan Sub Pod</h3><p className="text-sm text-foreground/70">Izolăm tavanul ultimei camere de sub pod. Cel mai eficient punct de izolare.</p></div>
              <div key={"1"} className="p-6 border border-border rounded-none"><h3 className="font-semibold mb-2">Planșeu Între Etaje</h3><p className="text-sm text-foreground/70">Reducere zgomot și pierderi termice între niveluri.</p></div>
              <div key={"2"} className="p-6 border border-border rounded-none"><h3 className="font-semibold mb-2">Pod Neamenajat</h3><p className="text-sm text-foreground/70">Izolăm podeaua podului. Mai ieftin decât izolarea acoperișului.</p></div>
              <div key={"3"} className="p-6 border border-border rounded-none"><h3 className="font-semibold mb-2">Pivniță și Subsol</h3><p className="text-sm text-foreground/70">Izolăm tavanul subsolului — podea mai caldă la parter.</p></div>
              <div key={"4"} className="p-6 border border-border rounded-none"><h3 className="font-semibold mb-2">Tavan Industrial</h3><p className="text-sm text-foreground/70">Hale și depozite cu tavan înalt. Economiești enorm la încălzire.</p></div>
              <div key={"5"} className="p-6 border border-border rounded-none"><h3 className="font-semibold mb-2">Tavan Între Apartamente</h3><p className="text-sm text-foreground/70">Soluție pentru blocuri — reducere zgomot de la vecini de sus.</p></div>
            </div>
          </div>
        </section>
