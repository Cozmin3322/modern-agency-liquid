      ...
      <main className="bg-background">
        ...
        <section className="relative min-h-[60vh] flex items-center pt-20 bg-[#2C3E50]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
            <div className="max-w-3xl">
              ...
              <h1 className="text-5xl lg:text-6xl font-serif font-medium text-white mb-6">Termoizolare Cisterne și Rezervoare cu Spumă Poliuretanică</h1>
        ...
        <section className="py-20 bg-card">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div key={"0"} className="p-6 border border-border rounded-lg"><Check className="w-5 h-5 text-accent mb-3" /><h3 className="font-semibold mb-2">Menținerea temperaturii lichidelor</h3><p className="text-sm text-foreground/70">Izolez termic perfect — conținutul rămâne la temperatura dorită indiferent de sezon.</p></div>
              <div key={"1"} className="p-6 border border-border rounded-lg"><Check className="w-5 h-5 text-accent mb-3" /><h3 className="font-semibold mb-2">Eliminare condens exterior</h3><p className="text-sm text-foreground/70">Celula închisă previne formarea condensului care corodează metalul.</p></div>
              <div key={"2"} className="p-6 border border-border rounded-lg"><Check className="w-5 h-5 text-accent mb-3" /><h3 className="font-semibold mb-2">Aderare pe orice formă</h3><p className="text-sm text-foreground/70">Spuma urmează perfect orice curbură — cilindri, sfere, forme neregulate.</p></div>
              <div key={"3"} className="p-6 border border-border rounded-lg"><Check className="w-5 h-5 text-accent mb-3" /><h3 className="font-semibold mb-2">Protecție anti-coroziune</h3><p className="text-sm text-foreground/70">Stratul de spumă protejează metalul de umiditate și oxidare.</p></div>
              <div key={"4"} className="p-6 border border-border rounded-lg"><Check className="w-5 h-5 text-accent mb-3" /><h3 className="font-semibold mb-2">Rezistentă la intemperii</h3><p className="text-sm text-foreground/70">UV, ploaie, îngheț — cu finisaj adecvat rezistă la toate condițiile.</p></div>
              <div key={"5"} className="p-6 border border-border rounded-lg"><Check className="w-5 h-5 text-accent mb-3" /><h3 className="font-semibold mb-2">Garanție 25 ani</h3><p className="text-sm text-foreground/70">Soluție permanentă fără reizolare.</p></div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div key={"0"} className="p-6 border border-border rounded-lg"><h3 className="font-semibold mb-2">Turn de Apă</h3><p className="text-sm text-foreground/70">Izolație completă — apa nu îngheață iarna, nu se supraîncălzește vara.</p></div>
              <div key={"1"} className="p-6 border border-border rounded-lg"><h3 className="font-semibold mb-2">Rezervor de Combustibil</h3><p className="text-sm text-foreground/70">Menții vâscozitatea combustibilului. Funcționare optimă pe ger.</p></div>
              <div key={"2"} className="p-6 border border-border rounded-lg"><h3 className="font-semibold mb-2">Cisternă Agricolă</h3><p className="text-sm text-foreground/70">Protejezi îngrășămintele și pesticidele de variațiile de temperatură.</p></div>
              <div key={"3"} className="p-6 border border-border rounded-lg"><h3 className="font-semibold mb-2">Rezervor Industrial</h3><p className="text-sm text-foreground/70">Substanțe chimice la temperaturi stabile. Siguranță sporită.</p></div>
              <div key={"4"} className="p-6 border border-border rounded-lg"><h3 className="font-semibold mb-2">Bazin Apă Potabilă</h3><p className="text-sm text-foreground/70">Materiale certificate alimentar. Apa rece vara, neînghețată iarna.</p></div>
              <div key={"5"} className="p-6 border border-border rounded-lg"><h3 className="font-semibold mb-2">Cisternă Transportabilă</h3><p className="text-sm text-foreground/70">Izolăm cisternele mobile — transport produse sensibile la temperatură.</p></div>
            </div>
          </div>
        </section>
