...
export const metadata: Metadata = {
  ...
  description: "Termoizolare profesională în Hîncești cu spumă poliuretanică. Case private, acoperișuri, mansarde. Deplasare gratuită, garanție 25 ani.",
        ...
        <section className="py-20 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ["Cunoaștem condițiile locale", "Climatul din raionul Hîncești — temperaturi extreme iarna, umiditate sezoniera. Știm exact ce tip de spumă funcționează cel mai bine."],
