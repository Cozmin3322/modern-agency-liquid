...
const breadcrumb = breadcrumbSchema([
  ...
  { name: 'Termoizolare Hîncești', url: 'https://www.isothermlux.md/termoizolare-hincesti' }
])

export const metadata: Metadata = {
  title: "Termoizolare Hîncești cu Spumă Poliuretanică | IsoThermLux",
  description: "Termoizolare profesională în Hîncești cu spumă poliuretanică. Case private, acoperișuri, mansarde. Deplasare gratuită, garanție 25 de ani.",
  keywords: "termoizolare hîncești, izolare hîncești, spumă poliuretanică hîncești, termoizolare raionul Hîncești, izolare termică hîncești Moldova",
  alternates: { canonical: "https://www.isothermlux.md/termoizolare-hincesti" },
}

const AREAS = ["Hîncești oraș", "Caracui", "Mingir", "Sărata-Galbenă", "Lăpușna", "Cărpineni"]

export default function Page() {
  return (
    <>
      <Script id="breadcrumb-termoizolare-hincesti" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumb) }} />
      <Header />
      <main className="bg-background">
        ...
        <section className="relative min-h-[65vh] flex items-end pt-20 bg-[#1A1D21]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 w-full">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="font-mono text-sm text-accent uppercase tracking-widest">raionul Hîncești</span>
            </div>
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-serif text-white mb-6 max-w-3xl">
              Termoizolare Hîncești
            </h1>
            <p className="text-xl text-white/75 mb-10 max-w-2xl leading-relaxed">
              Servicii profesionale de termoizolare cu spumă poliuretanică în Hîncești și raionul Hîncești. <span className="text-accent font-semibold">74+ proiecte</span> finalizate. Garanție 25 de ani. Deplasare gratuită.
            </p>
        ...
        <div className="bg-accent">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex flex-wrap gap-8 justify-center md:justify-start">
              {[
                ["74+", "Proiecte în raionul Hîncești"],
        ...
        <section className="py-20 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-serif uppercase mb-12">Servicii în Hîncești</h2>
        ...
        <section className="py-20 bg-card">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-serif uppercase mb-12">Zone Deservite în Hîncești</h2>
            ...
            <p className="text-muted-foreground text-sm mt-6 font-mono">
              * Intervenție și în localitățile din raionul Hîncești. Deplasare gratuită pentru evaluare.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-serif uppercase mb-12">De Ce IsoThermLux în Hîncești?</h2>
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ["Cunoaștem condițiile locale", "Climatul din raionul Hîncești — temperaturi extreme iarna, umiditate sezonieră. Știm exact ce tip de spumă funcționează cel mai bine."],
                ["74+ proiecte realizate", "Experiență vastă în Hîncești și raionul Hîncești. Clienții noștri pot fi contactați pentru referințe."],
                ["Deplasare gratuită la Hîncești", "Evaluare pe loc fără costuri. Ofertă personalizată în 24h."],
