...
const breadcrumb = breadcrumbSchema([
  ...
  { name: 'Termoizolare Soroca', url: 'https://www.isothermlux.md/termoizolare-soroca' }
])

export const metadata: Metadata = {
  title: "Termoizolare Soroca cu Spumă Poliuretanică | IsoThermLux",
  description: "Termoizolare profesională în Soroca și nordul Moldovei cu spumă poliuretanică. Case, hale agricole, depozite. Garanție 25 ani.",
  keywords: "termoizolare soroca, izolare soroca, spumă poliuretanică soroca, termoizolare raionul Soroca, izolare termică soroca Moldova",
  alternates: { canonical: "https://www.isothermlux.md/termoizolare-soroca" },
}

const AREAS = ["Soroca oraș", "Parcani", "Rudi", "Vărăncău", "Cosauti", "Slobozia-Cremene"]

export default function Page() {
  return (
    <>
      <Script id="breadcrumb-termoizolare-soroca" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumb) }} />
      <Header />
      <main className="bg-background">
        ...
        <section className="relative min-h-[65vh] flex items-end pt-20 bg-[#1A1D21]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 w-full">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="font-mono text-sm text-accent uppercase tracking-widest">raionul Soroca</span>
            </div>
            ...
            <p className="text-xl text-white/75 mb-10 max-w-2xl leading-relaxed">
              Servicii profesionale de termoizolare cu spumă poliuretanică în Soroca și raionul Soroca. <span className="text-accent font-semibold">87+ proiecte</span> finalizate. Garanție 25 ani. Deplasare gratuită.
            </p>
        ...
        <section className="py-20 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-4 mb-12">
              ...
              <h2 className="text-4xl font-serif uppercase">Servicii în Soroca</h2>
            </div>
        ...
        <section className="py-20 bg-card">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-4 mb-12">
              ...
              <span className="h-px w-12 bg-border" />
              <h2 className="text-4xl font-serif uppercase">Zone Deservite în Soroca</h2>
            </div>
            ...
            <p className="text-muted-foreground text-sm mt-6 font-mono">
              * Intervenție și în localitățile din raionul Soroca. Deplasare gratuită pentru evaluare.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-4 mb-12">
              ...
              <span className="h-px w-12 bg-border" />
              <h2 className="text-4xl font-serif uppercase">De Ce IsoThermLux în Soroca?</h2>
            </div>
        ...
        <section className="py-20 bg-[#1A1D21] text-center">
          <div className="max-w-3xl mx-auto px-4">
            <span className="font-mono text-xs text-accent uppercase tracking-widest block mb-4">Soroca · raionul Soroca</span>
            <h2 className="text-4xl font-serif text-white mb-4">Cere Ofertă Gratuită în Soroca</h2>
