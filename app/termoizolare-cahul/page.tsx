...
const breadcrumb = breadcrumbSchema([
  ...
  { name: 'Termoizolare Cahul', url: 'https://www.isothermlux.md/termoizolare-cahul' }
])

export const metadata: Metadata = {
  title: "Termoizolare Cahul cu Spumă Poliuretanică | IsoThermLux",
  description: "Termoizolare profesională în Cahul și sudul Moldovei cu spumă poliuretanică. Case, hale, depozite. Deplasare gratuită, garanție 25 de ani.",
  keywords: "termoizolare cahul, izolare cahul, spumă poliuretanică cahul, termoizolare raionul Cahul, izolare termică cahul Moldova",
  alternates: { canonical: "https://www.isothermlux.md/termoizolare-cahul" },
}

const AREAS = ["Cahul oraș", "Roșu", "Crihana Veche", "Vadul lui Isac", "Giurgiulești", "Lebedenco"]

export default function Page() {
  return (
    <>
      <Script id="breadcrumb-termoizolare-cahul" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumb) }} />
      <Header />
      <main className="bg-background">
        ...
        <section className="relative min-h-[65vh] flex items-end pt-20 bg-[#1A1D21]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 w-full">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="font-mono text-sm text-accent uppercase tracking-widest">raionul Cahul</span>
            </div>
            ...
            <p className="text-xl text-white/75 mb-10 max-w-2xl leading-relaxed">
              Servicii profesionale de termoizolare cu spumă poliuretanică în Cahul și raionul Cahul. <span className="text-accent font-semibold">156+ proiecte</span> finalizate. Garanție 25 de ani. Deplasare gratuită.
            </p>
        ...
        <section className="py-20 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-serif uppercase mb-12">Servicii în Cahul</h2>
        ...
        <section className="py-20 bg-card">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-serif uppercase mb-12">Zone Deservite în Cahul</h2>
            ...
            <p className="text-muted-foreground text-sm mt-6 font-mono">
              * Intervenție și în localitățile din raionul Cahul. Deplasare gratuită pentru evaluare.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-serif uppercase mb-12">De Ce IsoThermLux în Cahul?</h2>
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ["Cunoaștem condițiile locale", "Climatul din raionul Cahul — temperaturi extreme iarna, umiditate sezonieră. Știm exact ce tip de spumă funcționează cel mai bine."],
                ["156+ proiecte realizate", "Experiență vastă în Cahul și raionul Cahul. Clienții noștri pot fi contactați pentru referințe."],
                ["Deplasare gratuită la Cahul", "Evaluare pe loc fără costuri. Ofertă personalizată în 24h."],
        ...
        <section className="py-20 bg-[#1A1D21] text-center">
          <div className="max-w-3xl mx-auto px-4">
            <span className="font-mono text-xs text-accent uppercase tracking-widest block mb-4">Cahul · raionul Cahul</span>
            <h2 className="text-4xl font-serif text-white mb-4">Cere Ofertă Gratuită în Cahul</h2>
