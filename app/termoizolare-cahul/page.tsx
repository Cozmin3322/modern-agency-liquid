        ...
        <section className="py-20 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ["Cunoaștem condițiile locale", "Climatul din raionul Cahul — temperaturi extreme iarna, umiditate sezoniera. Știm exact ce tip de spumă funcționează cel mai bine."],
