...
const breadcrumb = breadcrumbSchema([
  ...
  { name: 'Termoizolare Chișinău', url: 'https://www.isothermlux.md/termoizolare-chisinau' }
])

export const metadata: Metadata = {
  title: "Termoizolare Chișinău cu Spumă Poliuretanică | IsoThermLux",
  description: "Termoizolare profesională în Chișinău cu spumă poliuretanică. Cel mai mare număr de proiecte finalizate în capitală. Deplasare gratuită, ofertă în 30 min.",
  keywords: "termoizolare chișinău, izolare chișinău, spumă poliuretanică chișinău, termoizolare municipiul Chișinău, izolare termică chișinău Moldova",
  alternates: { canonical: "https://www.isothermlux.md/termoizolare-chisinau" },
}

const AREAS = ["Centru", "Buiucani", "Rîșcani", "Ciocana", "Botanica", "Telecentru", "Codru", "Durlești", "Sculeni", "Truseni"]

export default function Page() {
  return (
    <>
      <Script id="breadcrumb-termoizolare-chisinau" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumb) }} />
      <Header />
      <main className="bg-background">
        ...
        <section className="relative min-h-[65vh] flex items-end pt-20 bg-[#1A1D21]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 w-full">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="font-mono text-sm text-accent uppercase tracking-widest">municipiul Chișinău</span>
            </div>
            ...
            <p className="text-xl text-white/75 mb-10 max-w-2xl leading-relaxed">
              Servicii profesionale de termoizolare cu spumă poliuretanică în Chișinău și municipiul Chișinău. <span className="text-accent font-semibold">1240+ proiecte</span> finalizate. Garanție 25 de ani. Deplasare gratuită.
            </p>
        ...
        <div className="bg-accent">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex flex-wrap gap-8 justify-center md:justify-start">
              {[
                ["1240+", "Proiecte în municipiul Chișinău"],
        ...
        <section className="py-20 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-serif uppercase mb-12">Servicii în Chișinău</h2>
        ...
        <section className="py-20 bg-card">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-serif uppercase mb-12">Zone Deservite în Chișinău</h2>
            ...
            <p className="text-muted-foreground text-sm mt-6 font-mono">
              * Intervenție și în localitățile din municipiul Chișinău. Deplasare gratuită pentru evaluare.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-serif uppercase mb-12">De Ce IsoThermLux în Chișinău?</h2>
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ["Cunoaștem condițiile locale", "Climatul din municipiul Chișinău — temperaturi extreme iarna, umiditate sezonieră. Știm exact ce tip de spumă funcționează cel mai bine."],
                ["1240+ proiecte realizate", "Experiență vastă în Chișinău și municipiul Chișinău. Clienții noștri pot fi contactați pentru referințe."],
                ["Deplasare gratuită la Chișinău", "Evaluare pe loc fără costuri. Ofertă personalizată în 24h."],
        ...
        <section className="py-20 bg-[#1A1D21] text-center">
          <div className="max-w-3xl mx-auto px-4">
            <span className="font-mono text-xs text-accent uppercase tracking-widest block mb-4">Chișinău · municipiul Chișinău</span>
            <h2 className="text-4xl font-serif text-white mb-4">Cere Ofertă Gratuită în Chișinău</h2>
