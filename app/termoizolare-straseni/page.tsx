        ...
        <section className="py-20 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-4 mb-12">
              ...
              <h2 className="text-4xl font-serif uppercase">Servicii în Strășeni</h2>
            </div>
        ...
        <section className="py-20 bg-card">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-4 mb-12">
              ...
              <span className="h-px w-12 bg-border" />
              <h2 className="text-4xl font-serif uppercase">Zone Deservite în Strășeni</h2>
            </div>
        ...
        <section className="py-20 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-4 mb-12">
              ...
              <span className="h-px w-12 bg-border" />
              <h2 className="text-4xl font-serif uppercase">De Ce IsoThermLux în Strășeni?</h2>
            </div>
