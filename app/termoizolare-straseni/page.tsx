...
const breadcrumb = breadcrumbSchema([
  ...
  { name: 'Termoizolare Strășeni', url: 'https://www.isothermlux.md/termoizolare-straseni' }
])
...
const AREAS = ["Strășeni oraș", "Bucovăț", "Lozova", "Micăuți", "Recea", "Codreanca"]

export default function Page() {
  return (
    <>
      <Script id="breadcrumb-termoizolare-straseni" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumb) }} />
      <Header />
      <main className="bg-background">
        ...
        <section className="relative min-h-[65vh] flex items-end pt-20 bg-[#1A1D21]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 w-full">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="font-mono text-sm text-accent uppercase tracking-widest">raionul Strășeni</span>
            </div>
        ...
        <section className="py-20 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-serif uppercase mb-12">Servicii în Strășeni</h2>
        ...
        <section className="py-20 bg-card">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-serif uppercase mb-12">Zone Deservite în Strășeni</h2>
            ...
            <p className="text-muted-foreground text-sm mt-6 font-mono">
              * Intervenție și în localitățile din raionul Strășeni. Deplasare gratuită pentru evaluare.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-serif uppercase mb-12">De Ce IsoThermLux în Strășeni?</h2>
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ["Cunoaștem condițiile locale", "Climatul din raionul Strășeni — temperaturi extreme iarna, umiditate sezonieră. Știm exact ce tip de spumă funcționează cel mai bine."],
                ["112+ proiecte realizate", "Experiență vastă în Strășeni și raionul Strășeni. Clienții noștri pot fi contactați pentru referințe."],
                ["Deplasare gratuită la Strășeni", "Evaluare pe loc fără costuri. Ofertă personalizată în 24h."],
